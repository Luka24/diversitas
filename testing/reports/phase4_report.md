...
|---|---|---|---|---|---|---|---|
| lean | BTC | 1.01 [+0.09, +1.95] | ✓ | 0.85 [-0.04, 3.00] | -39% [-66%, -25%] | 15% | 0.20 |
| lean | ETH | 0.85 [-0.02, +1.76] | ✗ | 0.52 [-0.17, 2.77] | -61% [-88%, -30%] | 20% | — |
| lean | SOL | 0.97 [-0.18, +1.97] | ✗ | 0.71 [-0.19, 3.75] | -59% [-81%, -31%] | 6% | — |
| mome | BTC | 1.18 [+0.30, +2.06] | ✓ | 1.02 [0.08, 3.60] | -38% [-60%, -22%] | 52% | 0.14 |
| mome | ETH | 1.13 [+0.29, +1.94] | ✓ | 1.28 [0.08, 3.45] | -32% [-61%, -24%] | 72% | — |
| mome | SOL | 1.17 [+0.03, +2.13] | ✓ | 1.12 [-0.06, 3.89] | -37% [-62%, -24%] | 97% | — |

## Interpretation

- **Sharpe 95% CI excludes 0 in 4/6 cases** (block bootstrap that preserves volatility clustering — a naive IID shuffle would look artificially tighter). Where it includes 0, the per-asset edge is not bootstrap-significant on its own.
